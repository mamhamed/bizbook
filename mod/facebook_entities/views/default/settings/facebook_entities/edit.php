...
$consumer_key_string = elgg_echo('facebook_entities:consumer_key');
...
$consumer_secret_string = elgg_echo('facebook_entities:consumer_secret');
...
$sign_on_with_facebook_string = elgg_echo('facebook_entities:login');
...
$new_users_with_facebook = elgg_echo('facebook_entities:new_users');
...
$post_on_facebook = elgg_echo('facebook_entities:post_onfb');
