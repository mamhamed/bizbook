...
if (array_key_exists('value', $vars)) {
	...
	$value = elgg_echo('metropolis_theme:search');
}
...
<form class="<?php echo $class; ?>" action="<?php echo elgg_get_site_url(); ?>search" method="get">
	<fieldset>
		<input type="text" class="search-input" size="21" name="q" value="<?php echo $display_query; ?>" onblur="if (this.value=='') { this.value='<?php echo elgg_echo('metropolis_theme:search'); ?>' }" onfocus="if (this.value=='<?php echo elgg_echo('metropolis_theme:search'); ?>') { this.value='' };" />
