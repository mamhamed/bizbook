<?php
	...
	function cmr_event_create_friendrequest($event, $object_type, $object) {
		...
		if (($object instanceof ElggRelationship)) {
			...
			// Notify target user
			$subject = elgg_echo('cmr:friend_request:newfriend:subject', array($user_one->name));
			$message = elgg_echo("cmr:friend_request:newfriend:body", array($user_one->name, $view_friends_url));
